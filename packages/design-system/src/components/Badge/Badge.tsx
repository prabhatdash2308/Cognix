...
const variantStyles: Record<BadgeVariant, { badge: string; dot: string }> = {
  ...
  brand: {
    badge:
      "bg-[var(--color-accent-subtle)] text-[var(--color-brand-300)] border border-[oklch(0.627_0.200_275_/_0.25)]",
    dot: "bg-[var(--color-accent)]",
  },
  success: {
    badge:
      "bg-[oklch(0.648_0.158_145_/_0.12)] text-[var(--color-success-light)] border border-[oklch(0.648_0.158_145_/_0.25)]",
    dot: "bg-[var(--color-success)]",
  },
  warning: {
    badge:
      "bg-[oklch(0.762_0.180_80_/_0.12)] text-[var(--color-warning-light)] border border-[oklch(0.762_0.180_80_/_0.25)]",
    dot: "bg-[var(--color-warning)]",
  },
  error: {
    badge:
      "bg-[oklch(0.638_0.208_20_/_0.12)] text-[var(--color-error-light)] border border-[oklch(0.638_0.208_20_/_0.25)]",
    dot: "bg-[var(--color-error)]",
  },
  info: {
    badge:
      "bg-[oklch(0.596_0.165_220_/_0.12)] text-[var(--color-info-light)] border border-[oklch(0.596_0.165_220_/_0.25)]",
...
export function Badge({
  ...
  return (
    ...
    >
      {dot && (
        <span
          className={cn("shrink-0 rounded-[var(--radius-full)]", dotSizeStyles[size], dotColor)}
          aria-hidden
        />
      )}
      {children}
