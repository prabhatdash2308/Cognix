...
SYSTEM_ROLES: list[tuple[str, bool, int, str, list[str]]] = [
    ...
    (
        ...
        [
            ...
            "tasks.read", "tasks.create", "tasks.write", "tasks.delete", "tasks.assign",
            "documents.read", "documents.write", "documents.delete",
            "agents.read", "agents.manage", "agents.delete",
            "knowledge.read", "knowledge.write", "knowledge.delete",
            "automation.read", "automation.manage",
            "members.read", "members.manage", "members.remove",
    ...
    (
        ...
        [
            ...
            "tasks.read", "tasks.create", "tasks.write", "tasks.assign",
    ...
    (
        ...
        [
            "projects.read",
            "tasks.read", "tasks.create", "tasks.write",
            "documents.read", "documents.write",
            "agents.read",
            "knowledge.read",
            "members.read",
